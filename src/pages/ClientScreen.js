...
export default function ClientScreen() {
    ...
    function handleSubmit(e) {
        ...
        toast.success('Cadastro realizado, temos mais um cliente!')
        ...
        <div className="container">
            ...
            <div className="form-container">
                <form onSubmit={handleSubmit}>
                    ...
                    <label>
                        WhatsApp: <input type="number" value={whats} onChange={e => setWhats(e.target.value)} required />
